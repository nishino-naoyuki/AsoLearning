...
ALTER TABLE RESULT_TBL
	ADD FOREIGN KEY (INFOMATION_ID)
	REFERENCES TASK_TBL (INFOMATION_ID)
	ON UPDATE RESTRICT
	ON DELETE RESTRICT
;
...
CREATE INDEX IDX_USER_USERID_TASKID ON RESULT_TBL (USER_ID ASC, INFOMATION_ID ASC);
...
CREATE INDEX IDX_TP_TBL_TASKID_COURSEID ON TASK_PUBLIC_TBL (INFOMATION_ID ASC, COURSE_ID ASC, STATUS_ID ASC);
CREATE INDEX IDX_TASK_CREATE_USER_ID ON TASK_TBL (CREATE_USER_ID ASC);
CREATE INDEX IDX_TASK_TBL_NAME ON TASK_TBL (NAME ASC);
CREATE INDEX IDX_TESTCASE_TASK_TASKCASE ON TESTCASE_TABLE (INFOMATION_ID ASC, TESTCASE_ID ASC);
