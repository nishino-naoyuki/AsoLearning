 ...
 *
 */
@WebServlet(name="UpdateAvatarInputServlet",urlPatterns={"/updateavatarinput"})
public class UpdateAvatarInputServlet extends BaseServlet {

	Logger logger = LoggerFactory.getLogger(UpdateAvatarInputServlet.class);
